...
import {
  ...
  FileText, X, CheckCircle, Loader2, ArrowRight, Package,
} from "lucide-react";
...
export default function VendedorPedidosPage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Nuevo Pedido de Vendedor</h1>
            ...
            <AnimatePresence>
              {filteredProducts.length > 0 && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -10 }}
                  className="mt-3 border border-gray-100 rounded-xl divide-y divide-gray-50 overflow-hidden"
                >
