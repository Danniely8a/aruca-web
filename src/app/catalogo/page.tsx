...
const brandHeroes: Record<string, { banner: string; color: string; tagline: string; description: string; categories: string[] }> = {
  Caiman: { banner: "/assets/brands/heroes/CAIMAN.jpg", color: "#E87722", tagline: "Fijaciones firmes, resultados impecables", description: "Clavos, grapas y fijaciones neumáticas para trabajos profesionales en madera.", categories: ["Clavos", "Grapas", "Medidas"] },
  "CMT Orange Tools": { banner: "/assets/brands/heroes/CMT.jpg", color: "#E87722", tagline: "Precisión Italiana", description: "Sierras y herramientas de corte de alta precisión para carpintería profesional.", categories: ["Sierras", "Fresas", "Herramientas"] },
  Fini: { banner: "/assets/brands/heroes/FINI.jpg", color: "#DC2626", tagline: "Compresores profesionales", description: "Compresores de pistón y tornillo para uso profesional e industrial.", categories: ["Compresores", "Accesorios"] },
  Forza: { banner: "/assets/brands/heroes/FORZA.jpg", color: "#2563EB", tagline: "Herramientas de alto rendimiento", description: "Herramientas neumáticas y eléctricas para profesionales.", categories: ["Herramientas neumáticas", "Herramientas eléctricas"] },
  ICA: { banner: "/assets/brands/heroes/ICA.jpg", color: "#16A34A", tagline: "Acabados profesionales", description: "Pinturas, barnices y acabados para madera y superficies.", categories: ["Pinturas", "Barnices", "Solventes"] },
  Makita: { banner: "/assets/brands/heroes/MAKITA.jpg", color: "#0066CC", tagline: "Herramientas profesionales", description: "Herramientas eléctricas y motorizadas de alto rendimiento.", categories: ["Herramientas eléctricas", "Accesorios"] },
  Titebond: { banner: "/assets/brands/heroes/TITEBOND.jpg", color: "#D4A017", tagline: "La marca líder en adhesivos", description: "Adhesivos y selladores profesionales para carpintería y construcción.", categories: ["Adhesivos", "Selladores", "Accesorios"] },
  Bremas: { banner: "/assets/brands/heroes/bremas.jpg", color: "#1E40AF", tagline: "Herramientas eléctricas profesionales", description: "Herramientas eléctricas y de mano para la industria.", categories: ["Herramientas Eléctricas", "Accesorios"] },
  "CMT Contractor": { banner: "/assets/brands/heroes/cmt-contractor.jpg", color: "#E87722", tagline: "Herramientas de corte profesional", description: "Línea profesional de herramientas de corte para contratistas.", categories: ["Sierras", "Fresas", "Herramientas"] },
  Dakin: { banner: "/assets/brands/heroes/dakin.jpg", color: "#DC2626", tagline: "Cintas de alta resistencia", description: "Cintas de acero sueco y bimetálicas para sierra de cinta.", categories: ["Cintas", "Sierras"] },
  Menequim: { banner: "/assets/brands/heroes/menequim.jpg", color: "#16A34A", tagline: "Pegamentos y acabados", description: "Pegamentos, solventes y acabados para carpintería.", categories: ["Adhesivos", "Solventes", "Acabados"] },
  Milescraft: { banner: "/assets/brands/heroes/milescraft.jpg", color: "#7C3AED", tagline: "Accesorios para carpintería", description: "Plantillas y accesorios especializados para carpintería.", categories: ["Plantillas", "Accesorios", "Herramientas"] },
  Newco: { banner: "/assets/brands/heroes/newco.jpg", color: "#2563EB", tagline: "Compresores industriales", description: "Compresores de alta eficiencia para múltiples aplicaciones.", categories: ["Compresores", "Industria"] },
  "Pony Jorgensen": { banner: "/assets/brands/heroes/pony-jorgensen.jpg", color: "#F59E0B", tagline: "Prensas y herramientas manuales", description: "Prensas, sargentos y herramientas manuales de alta calidad.", categories: ["Prensas", "Sargentos", "Herramientas"] },
  Sambara: { banner: "/assets/brands/heroes/sambara.jpg", color: "#0891B2", tagline: "Tratamiento de madera", description: "Productos para el tratamiento y acabado decorativo de madera.", categories: ["Tratamiento", "Acabados"] },
  Sicar: { banner: "/assets/brands/heroes/sicar.jpg", color: "#4F46E5", tagline: "Herramientas especializadas", description: "Herramientas y productos para la industria de la madera.", categories: ["Herramientas", "Accesorios"] },
};
