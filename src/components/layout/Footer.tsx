        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          <div>
            <div className="flex items-center gap-3 mb-5">
              ...
              />
              <div>
                <p className="font-bold text-white">ARUCA</p>
                <p className="text-gray-400 text-sm">Maquinarias</p>
              </div>
            </div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 bg-green-600 text-white text-sm font-medium rounded-xl hover:bg-green-700 active:scale-[0.98] transition-all"
            >
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <Phone size={16} className="text-brand-light mt-0.5 shrink-0" />
                <div>
                  <p className="text-gray-400 text-sm">{company.phone1}</p>
                  <p className="text-gray-400 text-sm">{company.phone2}</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <Mail size={16} className="text-brand-light mt-0.5 shrink-0" />
              ...
              <li className="flex items-start gap-3">
                ...
                <p className="text-gray-400 text-sm">{company.schedule}</p>
              </li>
            </ul>
          </div>

          <div>
            <h3 className="font-bold text-white mb-4">Marcas Aliadas</h3>
            ...
            <Link
              href="/catalogo"
              className="inline-block mt-4 text-brand-light text-sm hover:text-white transition-colors"
            >
              Ver todas →
            </Link>
            <div className="mt-5">
