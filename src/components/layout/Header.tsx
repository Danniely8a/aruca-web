...
import { Menu, X, Phone, ShoppingCart, User, LogOut, ChevronDown } from "lucide-react";
            ...
            {!authLoading && (
              <div className="relative hidden sm:block">
                {user ? (
                  ...
                  <Link
                    href="/login"
                    className="flex items-center gap-2 px-4 py-2 bg-brand text-white text-sm font-medium rounded-xl hover:bg-brand/90 transition-all"
                  >
                    <User size={16} />
