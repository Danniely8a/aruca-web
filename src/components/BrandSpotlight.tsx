    ...
    items: [
      {
        ...
        description: "Burros con prensas para sujeción de piezas.",
      ...
      },
      {
        ...
        description: "Multiherramienta 4AMP para cortes y lijados.",
      ...
      },
      {
        ...
        description: "Prensa de banco industrial 5\" de alta resistencia.",
        href: "/productos/pj-29050-prensa-de-banco-industrial",
      },
      {
        name: "Prensa para Ensamblar con Cincha",
        model: "3225",
        ...
        description: "Prensa para ensamblar con cincha de 12FT.",
